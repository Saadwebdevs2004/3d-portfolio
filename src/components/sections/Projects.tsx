        ...
        <div className="absolute inset-0 px-8 md:px-16 w-full max-w-6xl mx-auto flex items-center justify-center">
          ...
          >
            <div className="max-w-xl text-left pointer-events-auto">
              <span className="text-xs font-mono tracking-widest text-[#9D8DF1] uppercase mb-4 block">
                02 // SELECTED WORK
              </span>
              <h2 className="text-4xl md:text-6xl font-extrabold text-[#1A1A2E] tracking-tight uppercase mb-2 font-heading">
                {projectsData[0].title}
              </h2>
              <p className="text-sm font-mono text-[#4A4A6A] mb-6 uppercase tracking-wider">
                {projectsData[0].tagline}
              </p>
              <p className="text-[#4A4A6A] font-sans text-base md:text-lg leading-relaxed mb-8">
                {projectsData[0].description}
              </p>
              
              <div className="flex flex-wrap gap-2 mb-8">
                {projectsData[0].tech.map((t, idx) => (
                  <span key={idx} className="px-3 py-1 bg-[#9D8DF1]/10 border border-[#9D8DF1]/20 text-[10px] md:text-xs font-mono rounded-full text-[#1A1A2E]">
                    {t}
                  </span>
                ))}
              </div>
              ...
              <div className="flex gap-4">
                <MagneticButton>
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="flex items-center gap-2 px-5 py-2.5 bg-white border border-[#9D8DF1] rounded-full hover:bg-[#9D8DF1] hover:text-white transition-all text-xs font-mono text-[#1A1A2E] shadow-[0_4px_15px_rgba(157,141,241,0.1)] cursor-pointer"
                  >
